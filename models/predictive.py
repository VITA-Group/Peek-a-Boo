...
class PredictiveWeightQuantFunction(Function):
    ...
    def forward(ctx, weight, num_bits_weight, msb_bits_weight,
                threshold, sparsify, sign, writer, writer_prefix, counter, preserve_zero):
    ...
    def backward(ctx, *grad_output):
        ...
        with torch.no_grad():
            ...
            return grad_weight, None, None, None, None, None, None, None, None, None
