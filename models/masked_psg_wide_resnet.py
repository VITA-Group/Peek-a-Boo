...
class wide_basic(nn.Module):
    def __init__(self, in_planes, planes, dropout_rate, stride=1):
        ...
        self.conv1 = conv3x3(in_planes, planes, input_signed=False, predictive_forward=False, writer_prefix=None)
        ...
        if stride != 1 or in_planes != planes:
            self.shortcut = nn.Sequential(
                conv1x1(in_planes, planes, stride=stride, input_signed=True, predictive_forward=False, writer_prefix=None)
            )
...
class Wide_ResNet(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate=0, num_classes=10, init_method='standard'):
        ...
        self.conv1 = conv3x3(3, nStages[0], input_signed=True, predictive_forward=False, writer_prefix=None)
